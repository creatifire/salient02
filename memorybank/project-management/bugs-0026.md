...
| [BUG-0026-0003](#bug-0026-0003-session-created-without-accountagent-context-on-page-load) | Sessions created on page load without account/agent context (vapid sessions) | 🟡 In Progress |
