...
1. **BUG-0017-001** (P0): Streaming sends zero chunks but LLM completes successfully
...
## BUG-0017-001: Zero Chunks Streaming 🔴 P0
...
1. **BUG-0017-001** (P0): Breaks streaming → cascading failures
2. **BUG-0017-002** (P1): Quick config fix, prevents cost tracking errors
