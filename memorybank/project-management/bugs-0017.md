...
5. `backend/app/agents/config_file_cascade.py` (NEW - unified helper)

**Callers to Update**:
6. `backend/app/agents/simple_chat.py` (pass instance_slug to load_prompt_module)
7. `backend/app/agents/tools/prompt_generator.py` (pass instance_slug)

---

### Testing Strategy

**Test Matrix** (3 levels × 4 file types = 12 test cases):
